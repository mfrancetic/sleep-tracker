...
class SleepNightAdapter(val clickListener: SleepNightListener) : androidx.recyclerview.widget.ListAdapter<DataItem, RecyclerView.ViewHolder>(SleepNightDiffCallback()) {
    ...
    class ViewHolder private constructor(val binding: ListItemSleepNightBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(item: SleepNight, clickListener: SleepNightListener) {
            ...
            binding.executePendingBindings() // it will be faster
        }
...
// sealed class defines a closed type --> all subclasses of data item must be defined in this file
// as a result, number of subclasses is known to the compiler and it's not possible for another part
// of our code to define a new type of data item
sealed class DataItem {
    data class SleepNightItem(val sleepNight: SleepNight) : DataItem() {
        override val id = sleepNight.nightId
    }

    // object --> there will only ever be 1 instance of the header
